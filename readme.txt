...
This plugin adds integration between WishList Member and WP Courseware which allows you to associate courses to membership levels for automatic enrollment.
...
The WishList Member Addon for WP Courseware will add full integration with WP Courseware. Simply assign WP Courseware courses to a WishList Member membership level. When a student purchases the membership level, they will automatically be enrolled into the associated courses.
